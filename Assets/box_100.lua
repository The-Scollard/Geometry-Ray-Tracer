...
can_p3 = gr.node('can_p3')
scene:add_child(can_p3)
can_p3:translate(-5, 5, -12)
can_p3:add_child(can_pack)

can_p4 = gr.node('can_p4')
scene:add_child(can_p4)
can_p4:translate(0, -5, -13)
can_p4:add_child(can_pack)

-- The lights
l1 = gr.light({200,200,400}, {0.8, 0.8, 0.8}, {1, 0, 0})
l2 = gr.light({0, 5, -20}, {0.4, 0.4, 0.8}, {1, 0, 0})

gr.render(scene, 'box_100.png', 512, 512, 
