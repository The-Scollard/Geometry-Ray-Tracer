...
white = gr.material({0.8, 0.8, 0.8}, {0.7, 0.7, 0.7}, 10)
orange = gr.material({1.0, 0.6, 0.1}, {0.5, 0.7, 0.5}, 25)
light_blue = gr.material({0.4, 0.7, 1.0}, {0.3, 0.6, 0.9}, 25)
mirror = gr.material({0.5, 0.5, 0.5}, {0.0, 0.0, 0.0}, 1250)

mirror:set_reflection(0.7)
...
scene:add_child(s1)
s1:scale(2, 2, 2)
s1:translate(5, 10, 20)
s1:set_material(light_blue)

white_light = gr.light({0.0, 100.0, 40.0}, {0.4, 0.4, 0.4}, {1, 0, 0})
l2 = gr.light({0.0, 10.0, 70.0}, {0.4, 0.4, 0.4}, {1, 0, 0})

gr.render(scene, 'glossy_reflection.png', 1024, 1024,
	  {0, 0, 0}, {0, 0, -1}, {0, 1, 0}, 50,
	  {0.3, 0.3, 0.3}, {white_light, l2})
